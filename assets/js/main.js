...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (function initSpeakers() {
    const speakerData = {
      ...
      10: {
        name: '李俊霖',
        title: '神經元科技股份有限公司 經營策略顧問',
        img: './assets/image/speaker-10.png',
        bio: `<p>現任神經元科技經營策略顧問，曾任倍智醫電（V5med）營運長、安克生醫展業副總，擁有超過21年醫療器材、數位健康與醫療AI產業國際市場開發經驗，成功拓展北美、歐洲、中東、亞洲及拉丁美洲等50餘國市場。</p>
			<p>長期專注於醫療AI產品國際商業化與海外市場拓展，涵蓋肺癌AI、甲狀腺AI、超音波AI及數位健康等領域，熟悉市場策略、法規布局、臨床合作及跨國策略聯盟，致力協助臺灣智慧醫療創新成果拓展國際市場。</p>`,
      },
    };
